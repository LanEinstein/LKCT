...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='LKCT', type=str, metavar='MODEL',
    ...
    parser.add_argument('--data_set', default='image_folder', choices=['image_folder'],
                        type=str, help='ImageNet dataset path')
    parser.add_argument('--output_dir', default='./LKCT_04',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./LOGS_04',
